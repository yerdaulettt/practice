...
// Source: p8/repository (interfaces: UserRepository)
//
// Generated by this command:
//
//	mockgen -destination repository/mock_user_repository.go -package repository -self_package p8/repository p8/repository UserRepository
//
